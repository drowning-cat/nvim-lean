...
vim.keymap.set("n", "gcC", "gcgc", { remap = true, desc = "Uncomment block" })
...
-- stylua: ignore start
vim.api.nvim_create_user_command("Load", function() safe_run("WARN", MiniSessions.read, root_session()) end, {})
vim.api.nvim_create_user_command("Save", function() safe_run("WARN", MiniSessions.write, root_session()) end, {})
vim.api.nvim_create_user_command("Last", function() safe_run("WARN", MiniSessions.read, MiniSessions.get_latest()) end, {})
-- stylua: ignore end
...
vim.api.nvim_create_autocmd("VimLeave", {
  desc = "Write session on `VimLeave`",
...
require("treesj").setup({ max_join_length = 750 })
-- stylua: ignore
